    ...
    return (
        <Layout title="Resume">
            <div className={styles.layout}>
                <div>
                    <div className={styles.name}>Carlos Alejandro Torija Bravo</div>
                    <div className={styles.title}>Solutions Architect</div>
...
const experienceData = [
    {
        ...
        responsibilities: [
            ...
            "Define and implement IT and Security processes, as well as building a Shared services team to align these projects in the organization",
            "Manage and align compliance efforts and concerns across the organization",
            "Establish organizational structure and refine processes for the engineering team",
        ],
    },
